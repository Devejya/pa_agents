...
export default function ChatPage() {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* Input area */}
      <div className="bg-white dark:bg-zinc-900 border-t border-gray-200 dark:border-zinc-800 p-3 sm:p-4 pb-safe sm:pb-safe shrink-0">
      ...
      <button className="fixed bottom-safe-20 sm:bottom-24 right-4 sm:right-6 w-9 h-9 sm:w-10 sm:h-10 bg-gray-800 dark:bg-zinc-700 text-white rounded-full flex items-center justify-center shadow-lg hover:bg-gray-700 dark:hover:bg-zinc-600 transition-colors z-30 text-sm sm:text-base">
        ?
      </button>
    </div>
  );
